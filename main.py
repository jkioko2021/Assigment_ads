...
# Load data
df = pd.read_csv('C:/ADS_APRIL/stockdata2.csv', index_col=0, parse_dates=True)
        ...
        html.Div(className='row',
                 children=[
                    html.Div(className='four columns div-user-controls',
                             children=[
                                 html.H2('ASSIGNEMENT 1 - STOCK PRICES'),
                                 html.P('TOPIC:Visualising time series with Plotly - Dash.'),
